...
namespace EFTConfiguration.Models
{
    internal class EFTConfigurationModel
    {
        ...
        public readonly GameObject EFTConfigurationPublic = new GameObject("EFTConfigurationPublic", typeof(Canvas),
            typeof(CanvasScaler), typeof(GraphicRaycaster));

        public readonly string ModPath = Path.Combine(Paths.PluginPath, "kmyuhkyuk-EFTApi");
