...
namespace EFTConfiguration
{
    ...
    {
        [SerializeField] 
        public GameObject eftConfiguration;

        [SerializeField] 
        public GameObject pluginInfo;
        ...
        [SerializeField]
        public GameObject stringDropdown;
        ...
        [SerializeField] 
        public GameObject stringAction;
