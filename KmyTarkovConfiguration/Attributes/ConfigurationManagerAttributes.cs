...
namespace KmyTarkovConfiguration.Attributes
{
    ...
    /// Config.AddSetting("X", "1", 1, new ConfigDescription(string.Empty, null, new ConfigurationManagerAttributes { IsAdvanced = true, Order = 3 }));
    /// // Override only Order, IsAdvanced stays as the default value assigned by ConfigManager
    /// Config.AddSetting("X", "2", 2, new ConfigDescription(string.Empty, null, new ConfigurationManagerAttributes { Order = 1 }));
    /// Config.AddSetting("X", "3", 3, new ConfigDescription(string.Empty, null, new ConfigurationManagerAttributes { Order = 2 }));
    /// </code>
    /// </example>
    /// <remarks>
...
#pragma warning disable 0169, 0414, 0649
    public sealed class ConfigurationManagerAttributes
    {
        ...
        /// <summary>
        ///     Force the setting modName to not be displayed. Should only be used with a <see cref="CustomDrawer" /> to get more
        ///     space.
