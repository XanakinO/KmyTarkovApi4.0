...
namespace KmyTarkovConfiguration.Controllers
{
    public class EFTConfigurationController : MonoBehaviour
    {
        ...
        private static readonly ManualLogSource KmyTarkovConfigurationLogger =
            BepInEx.Logging.Logger.CreateLogSource("KmyTarkovConfiguration");
        ...
        private void Start()
        {
            ...
            foreach (var pluginInfo in PluginInfos.Values)
            {
                ...
                KmyTarkovConfigurationLogger.LogMessage(
